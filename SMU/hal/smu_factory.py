...
import inspect
from SMU.hal.smu_hal import SMUHal

"""
Created by Cameron Basara, 2025

"""

_registry: Dict[str, Type[SMUHal]] = {}

def register_driver(name: str, cls: Type[SMUHal]) -> None:
    """Call once in each driver module to make it discoverable."""
    _registry[name] = cls

def create_driver(name: str, **params) -> SMUHal:
